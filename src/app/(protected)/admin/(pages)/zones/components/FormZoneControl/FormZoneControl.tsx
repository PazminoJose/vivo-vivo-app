...
import { usePostZone } from "../../services/postZone.service";
import { usePutZone } from "../../services/putZones.service";
...
export default function FormZoneControl() {
  ...
  // Mutation
  const { isPending: isPendingCreate, mutate: createZoneMutation } = usePostZone();

  const { isPending: isPendingUpdate, mutate: updateZoneMutation } = usePutZone();
